...
Citizen.CreateThread(function()
    ...
    local mafia1map = AddBlipForCoord(334.75, -2039.65, 21.1)

    SetBlipSprite(mafia1map, 310)
    SetBlipColour(mafia1map, 5)
    SetBlipScale(mafia1map, 0.80)
    SetBlipAsShortRange(mafia1map, true)
    BeginTextCommandSetBlipName('STRING')
    AddTextComponentString("Quartier")
    EndTextCommandSetBlipName(mafia1map)
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k,v in pairs(Config.pos) do
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mafia1' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'mafia1' then 
...
RMenu.Add('garagemafia1', 'main', RageUI.CreateMenu("Garage", "Garage mafia1"))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('garagemafia1', 'main'), true, true, true, function() 
        ...
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mafia1' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'mafia1' then    
                    ...
                    if IsControlJustPressed(1,51) then           
                        RageUI.Visible(RMenu:Get('garagemafia1', 'main'), not RageUI.Visible(RMenu:Get('garagemafia1', 'main')))
                    end   
                end
            end 
         end
...
function spawnuniCar(car)
    ...
    local plaque = "mafia1"..math.random(1,9)
...
RMenu.Add('coffremafia1', 'main', RageUI.CreateMenu("Coffre", " "))
RMenu.Add('coffremafia1', 'mettre', RageUI.CreateMenu("Coffre", " "))
RMenu.Add('coffremafia1', 'enlever', RageUI.CreateMenu("Coffre", " "))

Citizen.CreateThread(function()
    while true do

        RageUI.IsVisible(RMenu:Get('coffremafia1', 'main'), true, true, true, function()


            RageUI.ButtonWithStyle("Prendre objet", "Pour prendre un objet.", {RightLabel = "→"},true, function(Hovered, Active, Selected)
                if (Selected) then   
                RageUI.CloseAll()
                OpenGetStocksmafia1Menu()
                end
                end)
                RageUI.ButtonWithStyle("Déposer objet", "Pour déposer un objet.", {RightLabel = "→"},true, function(Hovered, Active, Selected)
                if (Selected) then   
                RageUI.CloseAll()
                OpenPutStocksmafia1Menu()
                end
                end)
...
Citizen.CreateThread(function()
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mafia1' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'mafia1' then  
                    ...
                    if IsControlJustPressed(1,51) then
                        RageUI.Visible(RMenu:Get('coffremafia1', 'main'), not RageUI.Visible(RMenu:Get('coffremafia1', 'main')))
                    end   
                end
               end 
        end
...
function OpenGetStocksmafia1Menu()
    ESX.TriggerServerCallback('esx_mafia1job:prendreitem', function(items)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_mafia1job:prendreitems', itemName, count)
...
function OpenPutStocksmafia1Menu()
    ESX.TriggerServerCallback('esx_mafia1job:inventairejoueur', function(inventory)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_mafia1job:stockitem', itemName, count)
...
function OpenGetWeaponMenu()
	...
	ESX.TriggerServerCallback('esx_mafia1job:getArmoryWeapons', function(weapons)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_get_weapon',
		{
			...
			ESX.TriggerServerCallback('esx_mafia1job:removeArmoryWeapon', function()
...
function OpenPutWeaponMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_put_weapon',
	{
		...
		ESX.TriggerServerCallback('esx_mafia1job:addArmoryWeapon', function()
...
RMenu.Add('mafia1f6', 'main', RageUI.CreateMenu("mafia1", "Intéraction"))
...
Citizen.CreateThread(function()
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('mafia1f6', 'main'), true, true, true, function()
        ...
        RageUI.ButtonWithStyle("Menotter/démenotter", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
            if (Selected) then 
                ...
                local target_id = GetPlayerServerId(target)
                if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_mafia1job:handcuff', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
            end
            ...
            RageUI.ButtonWithStyle("Escorter", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
                if (Selected) then
					...
					local target_id = GetPlayerServerId(target)
					if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_mafia1job:drag', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
            end
            ...
            RageUI.ButtonWithStyle("Mettre dans un véhicule", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
                if (Selected) then
					...
					local target_id = GetPlayerServerId(target)
					if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_mafia1job:putInVehicle', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
                end
            ...
            RageUI.ButtonWithStyle("Sortir du véhicule", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
                if (Selected) then
					...
					local target_id = GetPlayerServerId(target)
					if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_mafia1job:OutVehicle', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
            end
...
Citizen.CreateThread(function()
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mafia1' then  

                    if IsControlJustPressed(0, 167) then
                        RageUI.Visible(RMenu:Get('mafia1f6', 'main'), not RageUI.Visible(RMenu:Get('mafia1f6', 'main')))
                end   
        end 
    end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
            ...
            if ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'mafia1' then 
...
RegisterNetEvent('esx_mafia1job:handcuff')
AddEventHandler('esx_mafia1job:handcuff', function()
...
RegisterNetEvent('esx_mafia1job:drag')
AddEventHandler('esx_mafia1job:drag', function(cop)
...
RegisterNetEvent('esx_mafia1job:putInVehicle')
AddEventHandler('esx_mafia1job:putInVehicle', function()
...
RegisterNetEvent('esx_mafia1job:OutVehicle')
AddEventHandler('esx_mafia1job:OutVehicle', function(t)
...
function OpenBodySearchMenu(player)
	ESX.TriggerServerCallback('esx_mafia1job:getOtherPlayerData', function(data)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'body_search', {
			...
			if data.current.value then
				TriggerServerEvent('esx_mafia1job:confiscatePlayerItem', GetPlayerServerId(player), data.current.itemType, data.current.value, data.current.amount)
